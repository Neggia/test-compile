...
import { TestCompile } from '../src/contracts/testCompile'
...
async function main() {
    ...
    const instance = new TestCompile(
    ...
    console.log('TestCompile contract was successfully deployed!')
